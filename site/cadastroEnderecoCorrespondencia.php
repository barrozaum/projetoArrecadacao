...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/enderecoCorrespondencia.js"></script>
        <script src="recursos/js/camposNumeros.js"></script>
        <script src="recursos/js/mascaraCep.js"></script>
        <script src="recursos/js/mascaraTel.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formularioEnderecoCorrespondencia.php');
            }
        </script>
    </script>
