...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modalDividaImob.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formularioTabelaDividaImob.php');
                $('#listar').load('recursos/includes/listar/listarDividaImobs.php');
