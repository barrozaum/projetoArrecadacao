...
//      url para o arquivo para validação
        url: "recursos/includes/retornaValor/retornaRelatorioCertidaoRegularidadeFiscal.php",
//      dados passados
        data: {
            op: op,
...
//                CODIGOS 
                ...
                if (data.POSSUI_DIVIDAS === "0") {
                    $("#msg_erro").html("<div class='alert alert-danger'>INSCRIÇÃO POSSUI DÉBITOS !!! </div>");
                } 
                if (data.POSSUI_DIVIDAS === "1") {
                    $("#msg_erro").html("<div class='alert alert-danger'>INSCRIÇÃO NÃO POSSUI PARCELAMENTOS !!! </div>");
                } 
                if (data.POSSUI_DIVIDAS === "2"){
