...
function buscarDadosDocarj(parcela) {
    ...
    $("#formularioDocarj").attr("action", "recursos/includes/cadastrar/cadastrarEstornoPagamentoDocarj.php");
    $("#msg").html('');
    $("#button").html('');
    carregaTela();
...
//      url para o arquivo para validação
        url: "recursos/includes/retornaValor/retornaEstornoPagamentoDocarj.php",
        //      dados passados
        data: {
            txt_op: 1,
        ...
        success: function (data) {
            ...
            if (data.achou == 0) {
                ...
                $("#id_valor_Docarj").val(data.campo3);
                ...
                if (data.campo12 != "04")
                {
                    $("#msg").html('<div class="alert alert-warning" style="text-align:center; font-size:15px;"><strong>Docarj NÃO PAGO OU CANCELADO </strong></div>');
                } else {
...
//  armazeno valor dos campos do formuario em váriaveis
    ...
    var valor_itbi = $('#id_valor_Docarj').val();
