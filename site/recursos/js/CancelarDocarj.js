...
function buscarDadosDocarj(parcela) {
    ...
    $("#formularioDocarj").attr("action", "recursos/includes/cadastrar/cadastrarCancelamentoDocarj.php");
    $("#msg").html('');
    $("#button").html('');
    carregaTela();
...
//      url para o arquivo para validação
        url: "recursos/includes/retornaValor/retornaCancelamentoDocarj.php",
        //      dados passados
        data: {
            txt_op: 1,
