                ...
                <div class="well"><!-- div que coloca a cor no formulário -->
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php
                            $inscricao_inicial = (int) $_POST['txt_inscricao_inicial'];
                            $inscricao_final = (int) $_POST['txt_inscricao_final'];
                            $ano_inicial = (int) $_POST['txt_ano_inicial'];
                            $ano_final = (int) $_POST['txt_ano_final'];
...
//                            limpando as variaveis utilizadas em sessão
                        ...
                        <div class="col-sm-6 text-right">
                            <button type="button" class="btn btn-danger" onclick="location.href = '../../../CalcularIptu.php'">Sair</button>
                        </div>
                    </div>
                </div>
            </div>
