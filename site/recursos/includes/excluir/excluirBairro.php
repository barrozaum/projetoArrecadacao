...
//      Comando sql a ser executado 
        $sql = "DELETE  FROM bairro  WHERE Cod_Bairro = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaBairro.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Bairro Excluido com Sucesso !!!"; ?> ");
