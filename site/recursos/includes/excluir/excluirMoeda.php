...
//      Comando sql a ser executado 
       $sql = "DELETE  FROM tipo_moeda  WHERE Cod_tipo_moeda = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaMoeda.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Moeda Excluida com Sucesso !!!"; ?> ");
