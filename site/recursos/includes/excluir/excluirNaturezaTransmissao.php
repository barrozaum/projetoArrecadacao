...
//      Comando sql a ser executado 
       $sql = "DELETE  FROM Natureza_Transmissao  WHERE Cod_Natureza = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaNaturezaTransmissao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Natureza Excluida com Sucesso !!!"; ?> ");
