...
//      Comando sql a ser executado  
       $sql = "DELETE  FROM Situacao_Divida  WHERE Cod_Situacao_Divida = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaSituacaoDivida.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Situação Excluida com Sucesso !!!"; ?> ");
