...
//      Comando sql a ser executado 
       $sql = "DELETE  FROM Situacao_terreno  WHERE Cod_situacao = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaSituacaoTerreno.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Situação Terreno Excluido com Sucesso !!!"; ?> ");
