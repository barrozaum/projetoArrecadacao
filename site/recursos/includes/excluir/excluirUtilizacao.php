...
//      Comando sql a ser executado 
       $sql = "DELETE  FROM Utilizacao WHERE Codigo = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaUtilizacao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Utilização Excluida com Sucesso !!!"; ?> ");
