...
//      Comando sql a ser executado 
        $sql = "DELETE  FROM Tipo_Coleta  WHERE Cod_Tipo_Coleta = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Excluir  !!!");location.href = "../../../TabelaColeta.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Tipo Coleta Excluído com Sucesso !!!"; ?> ");
