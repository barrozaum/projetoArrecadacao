...
//      Comando sql a ser executado  
       $sql = "DELETE  FROM Valor_M2_Terreno  "
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Exlcuir  !!!");location.href = "../../../TabelaValorM2Terreno.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
