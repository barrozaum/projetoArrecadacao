...
//      Comando sql a ser executado 
        $sql = "UPDATE tipo_moeda SET Desc_tipo_moeda = '" . $descricao . "' WHERE Cod_tipo_moeda = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaMoeda.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Moeda Alterada com Sucesso !!!"; ?> ");
