...
//      Comando sql a ser executado 
        $sql = "UPDATE Patrimonio SET Descricao = '" . $descricao . "' WHERE Codigo = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaPatrimonio.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Patrimônio Alterado com Sucesso !!!"; ?> ");
