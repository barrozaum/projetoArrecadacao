...
//      Comando sql a ser executado  
        $sql = "UPDATE Valor_M2_Terreno "
                . "SET vlr_m2_terreno = '$valor'"
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaValorM2Terreno.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
