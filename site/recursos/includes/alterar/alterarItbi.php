...
//  DADOS IMOVEL
    ...
    if ((strlen($area_terreno_imovel) > 1) && (strlen($area_terreno_imovel) < 12) || is_int($area_terreno_imovel)) {
        ...
        $_SESSION['IMOV_AREA_TERRENO'] = $area_terreno_imovel;
    } else {
...
//      Comando sql a ser executado 
        $sql = "UPDATE Itbi "
                . "SET Adquirente = '$nome_completo_ad',"
                . "Tipo_Pessoa_Adquirente = '$tipo_pessoa_ad',"
                . "Cgc_Cpf_Adquirente = '$cpf_cnpj_ad',"
                . "Identidade_Adquirente = '$identidade_ad',"
                . "Rua_Adquirente = '$rua_ad',"
                . "Numero_Adquirente = '$numero_end_ad',"
                . "Compl_Adquirente = '$complemento_end_ad',"
                . "Bairro_Adquirente = '$bairro_ad',"
                . "Cidade_Adquirente = '$cidade_ad',"
                . "Uf_Adquirente = '$uf_ad',"
                . "Cep_Adquirente = '$cep_ad',"
                . "Transmitente = '$nome_completo_tr',"
                . "Tipo_Pessoa_Transmitente = '$tipo_pessoa_tr',"
                . "Cgc_Cpf_Transmitente = '$cpf_cnpj_tr',"
                . "Identidade_Transmitente = '$identidade_tr',"
                . "Rua_Transmitente = '$rua_tr',"
                . "Numero_Transmitente = '$numero_end_tr',"
                . "Compl_Transmitente = '$complemento_end_tr',"
                . "Bairro_Transmitente = '$bairro_tr',"
                . "Cidade_Transmitente = '$cidade_tr',"
                . "Uf_Transmitente = '$uf_tr',"
                . "Cep_Transmitente = '$cep_tr',"
                . "Inscricao_Imob = '$num_inscricao',"
                . "Proprietario = '$proprietario_imob',"
                . "Area_Terreno = '$area_terreno',"
                . "Fracao_ideal = '$fracao_ideal',"
                . "Utilizacao_Imovel = '$utilizacao',"
                . "Valor_Venal = '$valor_venal',"
                . "Cod_Rua = '$logradouro_imob',"
                . "Numero = '$numero_end_imob',"
                . "Complemento = '$complemento_imob',"
                . "Quadra = '$quadra_imob',"
                . "Num_Lote = '$lote_imob',"
                . "Cod_Bairro = '$bairro_imob',"
                ...
                . "Valor_Itbi = '$valor_total',"
                . "Data_Transacao = '$data_transacao',"
                . "Vencimento = '$vencimento',"
                . "Tem_Multa = '$Tem_Multa',"
                . "Declarante = '$declarante',"
                . "Observacao = '$obs_itbi'"
                . " WHERE Num_Itbi = '$numero_itbi'"
                . " AND Ano_Itbi = '$ano_itbi'";
...
//            die("ALTERAR ITBI " . $sql); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            ...
            location.href = "../guias/guia_itbi.php";
        </script>   
        <?php
//  if (empty($array_erros)) {
    } else {
