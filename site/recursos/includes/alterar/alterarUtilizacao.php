...
//      Comando sql a ser executado 
        $sql = "UPDATE Utilizacao SET Descricao = '".$descricao. "' WHERE Codigo = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaUtilizacao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Utilização Alterada com Sucesso !!!"; ?> ");
