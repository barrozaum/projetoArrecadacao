...
//      Comando sql a ser executado 
        $sql = "UPDATE Banco SET Desc_Banco = '" . $descricao . "' WHERE Cod_banco = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaBanco.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Banco Alterado com Sucesso !!!"; ?> ");
