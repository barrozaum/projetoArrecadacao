...
// verifico se o tamanho do campo é correto
    ...
    if ((strlen($descricao_Letra_Maiscula) > 2) && (strlen($descricao_Letra_Maiscula) < 16)) {
...
// verifico se tem erro na validação
    if (empty($array_erros)) {
        try {
            ...
            $stmt = $pdo->prepare("UPDATE Situacao_terreno SET Desc_situacao =:descricao WHERE Cod_situacao =:codigo");
    ...
    header("Location: ../../../TabelaSituacaoTerreno.php");
