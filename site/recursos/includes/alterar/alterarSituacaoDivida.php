...
//      Comando sql a ser executado  
        $sql = "UPDATE Situacao_Divida SET Desc_Situacao_Divida = '" . $descricao . "' WHERE Cod_Situacao_Divida = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaSituacaoDivida.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Situação Alterada com Sucesso !!!"; ?> ");
