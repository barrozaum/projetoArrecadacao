...
//      Comando sql a ser executado  
        $sql = "UPDATE Tipo_Coleta SET Desc_Tipo_Coleta = '" . $descricao . "' ,Valor = '" . $valor . "' WHERE Cod_Tipo_Coleta = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaColeta.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Tipo Coleta Alterado com Sucesso !!!"; ?> ");
