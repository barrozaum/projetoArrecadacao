...
//      Comando sql a ser executado 
        $sql = "UPDATE Natureza_Transmissao SET Desc_Natureza = '".$descricao. "' WHERE Cod_Natureza = '".$codigo."'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaNaturezaTransmissao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Natureza Alterada com Sucesso !!!"; ?> ");
