...
//      Comando sql a ser executado 
        $sql = "UPDATE bairro SET Desc_Bairro = '" . $descricao . "' WHERE Cod_Bairro = '" . $codigo . "'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Alterar  !!!");location.href = "../../../TabelaBairro.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Bairro Alterado com Sucesso !!!"; ?> ");
