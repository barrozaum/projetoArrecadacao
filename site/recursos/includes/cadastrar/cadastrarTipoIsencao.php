...
//      Comando sql a ser executado  
        $sql ="INSERT INTO Tipo_Isencao (Codigo, Descricao) VALUES ('$codigo', '$descricao')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaIsencao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Isenção Cadastrado com Sucesso !!!"; ?> ");
