...
//      Comando sql a ser executado  
        $sql = "INSERT INTO Patrimonio (Codigo, Descricao) VALUES ('$codigo', '$descricao')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaPatrimonio.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Patrimônio Cadastrado com Sucesso !!!"; ?> ");
            location.href = "../../../TabelaPatrimonio.php";
        </script>
