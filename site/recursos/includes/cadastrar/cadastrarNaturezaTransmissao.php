...
//      Comando sql a ser executado  
        $sql = "INSERT INTO Natureza_Transmissao (Cod_Natureza, Desc_Natureza) VALUES ('$codigo', '$descricao')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaNaturezaTransmissao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Natureza Cadastrada com Sucesso !!!"; ?> ");
            location.href = "../../../TabelaNaturezaTransmissao.php";
        </script>
