...
//      Comando sql a ser executado  
        $sql = "INSERT INTO Valor_M2_Construcao (Zona_Fiscal, Cod_Utilizacao, Cod_Categoria,Vlr_M2_Construcao) VALUES ('$codigo', '$cod_uti','$cod_cat', '$valor')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaValorM2Construcao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
