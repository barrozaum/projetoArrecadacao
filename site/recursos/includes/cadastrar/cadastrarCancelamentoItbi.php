...
//    aplica filtro na string enviada (LetraMaiuscula)
    ...
    $motivo_cancelamento_Letra_Maiscula = letraMaiuscula($_POST['txt_motivo_cancelamento']);
...
//    MOTIVO CANCELAMENTO
    if ((strlen($motivo_cancelamento_Letra_Maiscula) == 2) || is_int($motivo_cancelamento_Letra_Maiscula) === TRUE) {
        $motivo_cancelamento = $motivo_cancelamento_Letra_Maiscula;
    } else {
        $array_erros['txt_motivo_cancelamento'] = 'POR FAVOR ENTRE COM UM MOTIVO CANCELAMENTO VÁLIDO \n';
    }
...
//
        ...
        $sql = $sql . "dia_hora_pagto ='',";
        $sql = $sql . "Data_Cancelamento = '$data_cancelamento', ";
        $sql = $sql . "Cod_Motivo_Cancelamento = '$motivo_cancelamento'";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("ERROR AO REALIZAR CANCELAMENTO  !!!");location.href = "../../../CancelamentoItbi.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "CANCELAMENTO EFETUADO COM SUCESSO !!!"; ?> ");
            location.href = "../../../CancelamentoItbi.php";
        </script>
