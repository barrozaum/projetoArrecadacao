...
//      Comando sql a ser executado  
        $sql = "INSERT INTO Situacao_terreno (Cod_Situacao, Desc_Situacao) VALUES ('$codigo', '$descricao')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaSituacaoTerreno.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Situação Terreno Cadastrada com Sucesso !!!"; ?> ");
