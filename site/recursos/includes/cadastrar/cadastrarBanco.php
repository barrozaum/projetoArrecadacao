...
// filtro pra validar Nome do Bairro (não ter nenhum sql_injection)
    if (strlen($descricao_Letra_Maiscula) > 2) {
        ...
        $array_erros['txt_descricao'] = 'POR FAVOR ENTRE COM A DESCRIÇÃO BAIRRO VÁLIDA \n';
    }
...
//      Comando sql a ser executado  
       $sql = "INSERT INTO Banco (Cod_banco,Desc_Banco) VALUES ('$codigo', '$descricao')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaBanco.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Banco Cadastrado com Sucesso !!!"; ?> ");
                location.href = "../../../TabelaBanco.php";
        </script>
