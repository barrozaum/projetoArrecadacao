...
// aplica filtro na string enviada (LetraMaiuscula)
    ...
    $codigo_contabil_ano_Letra_Maiscula = letraMaiuscula($_POST['txt_codigo_ano']);
...
// verifico se tem erro na validação
    if (empty($array_erros)) {
        try {
            ...
            $sql = $sql . "(Cod_Divida_Imob, Desc_Divida, Venc_Cota_Unica, Desconto, Cod_Contabil, Cod_Contabil_DA,Cod_Contabil_Multa_Juros,DESC_COMPLETA)";
            $sql = $sql . " VALUES ";
            $sql = $sql . " (:codigoDividaImob, :descricaoDivida, :vencimentoCotaUnica, :desconto,  :codigoContabil,:codigoContabilDA, :codContabilMultaJuros, :descricaoDividaCompleta) ";
