...
//      Comando sql a ser executado  
        $sql = "INSERT INTO Utilizacao (Codigo, Descricao) VALUES ('$codigo', '$descricao')";
...
//          Caso tenha errro 
//          lanço erro na tela
            die('<script>window.alert("Erro ao Cadastrar  !!!");location.href = "../../../TabelaUtilizacao.php";</script>'); /* É disparado em caso de erro na inserção de movimento */
        } else {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Utilização Cadastrada com Sucesso !!!"; ?> ");
            location.href = "../../../TabelaUtilizacao.php";
        </script>
