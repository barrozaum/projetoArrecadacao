...
$livro = "";
$folha = "";
$data_Transacao = $_SESSION['T_DATA_TRAN'];
...
// ultima parte
$num_ano_itbi = $_SESSION['ITBI_NUMERO'] . "/" . $_SESSION['ITBI_ANO'];


//dados da guia 
$data_emissao_guia = date('d/m/Y'); // data da emissão da guia
$op_pagto = 'COTA ÚNICA'; // opção da parcela
