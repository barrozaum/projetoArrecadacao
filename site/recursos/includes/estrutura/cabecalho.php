...
<div class="mainbox col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0"> <!-- div que posiciona o formulário na tela -->
    <div class="row">
        <div class="col-lg-2 col-lg-offset-0 text-center">
            <a href="inicial.php">
                <img src="<?php echo $_SESSION['C_CAMINHO_LOGO']; ?>" height="76px" width="150" alt="logo cliente" title="logo da prefeitura">
                        ...
                        <li class="root">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu"> <a tabindex="-1" href="#">Certidões</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Certidões Negativa</a></li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu"> <a tabindex="-1" href="#">Emissão</a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">DOCARJ Pagos</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu"> <a tabindex="-1" href="#">Pagamento</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Baixa On Line</a></li>
