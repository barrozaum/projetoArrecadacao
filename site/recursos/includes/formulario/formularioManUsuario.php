                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?php
                                //   INPUT - Descricao Rua                             
                                criar_input_text('Matrícula', 'matricula', 'matricula', array('readonly' => 'true', 'required' => 'true', 'maxlength' => '11', 'placeholder' => 'MATRICULA COLABORADOR'), '', 'Conter no Minimo 2 caracteres');
                                ?>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-sm-6">
                                <?php
                                criar_input_text('Nome Completo', 'nome_completo', 'nome_completo', array('readonly' => 'true', 'required' => 'true', 'maxlength' => '50', 'placeholder' => 'NOME COMPLETO COLABORADOR'), '', 'Conter no Minimo 3 caracteres [a-z A-Z]');
                                ?>
                            </div>
                            <div class="col-sm-6">
                                <?php
                                criar_input_select('Nível Permissão', 'nivel_permissao', 'nivel_permissao', array('readonly' => 'true', 'required' => 'true'), array('' => 'SELECIONE PERMISSAO'));
                                ?>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-sm-6">
                                <?php
                                criar_input_password('Senha', 'senha_novo_login', 'senha_novo_login', array('readonly' => 'true', 'required' => 'true', 'maxlength' => '50', 'placeholder' => 'INFORME SENHA'), '', 'Conter no Minimo 3 caracteres');
                                ?>
                            </div>
                            <div class="col-sm-6">
                                <?php
                                criar_input_password('Confirme Senha', 'confirma_senha_novo_login', 'confirma_senha_novo_login', array('readonly' => 'true', 'required' => 'true', 'maxlength' => '50', 'placeholder' => 'CONFIRME SUA SENHA'), '', 'Conter no Minimo 3 caracteres');
                                ?>
                            </div>
                        </div> 
                        <div class="row">
