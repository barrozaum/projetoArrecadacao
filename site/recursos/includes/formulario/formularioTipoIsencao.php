...
function formularioAlterar() {
    ...
    $codigo = $_POST['codigo'];
    include_once '../estrutura/conexao/conexao.php';
    $sql = "Select * FROM Tipo_Isencao WHERE Codigo = '" . $codigo . "'";
    ...
    <form method="post" action="recursos/includes/alterar/alterarTipoIsencao.php">    

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Alterar Tipo Isenção</h4>
        </div>
...
function formularioExcluir() {
    ...
    <form method="post" action="recursos/includes/excluir/excluirTipoIsencao.php">    

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Excluir Tipo Isenção</h4>
        </div>

        <div class="modal-body">
            <p style="color: red">Deseja Prosseguir com a Exclusão da Isenção ?</p>
