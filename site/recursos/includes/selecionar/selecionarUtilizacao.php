        ...
        <head>
            ...
            <script languagem = "JavaScript">
                function opcao_selecionada(codigo, descricao) {
                    opener.document.getElementById('id_cod_utilizacao').value = codigo;
                    opener.document.getElementById('id_desc_utilizacao').value = descricao;
                    window.close();
                }
            </script>
            <script>
            ...
            <div id="carregamento">
                <script>
                    $(document).ready(function () {
                        ...
                        $('#carregamento').load('selecionarUtilizacao.php?janela=2');
                    });
                </script>
            </div>
        </body>
...
function dadosPagina() {
    ...
    <table id="table" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            $sql = "select * FROM Utilizacao order by Descricao";
