...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modalMoeda.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formularioTabelaMoeda.php');
                $('#listar').load('recursos/includes/listar/listarMoedas.php');
