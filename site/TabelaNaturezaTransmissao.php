...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modalNaturezaTransmissao.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formularioTabelaNaturezaTransmissao.php');
                $('#listar').load('recursos/includes/listar/listarNaturezasTransmissoes.php');
