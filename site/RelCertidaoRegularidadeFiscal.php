...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/relCertidaoRegularidadeFiscal.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formularioRelacaoCertidaoRegularidadeFiscal.php');
            }
        </script>
    </script>
