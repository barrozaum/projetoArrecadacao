...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modalBanco.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formularioTabelaBanco.php');
                $('#listar').load('recursos/includes/listar/listarBancos.php');
